    ...
    <body>
        ...
        <form action="" method="post">
            ...
            <div class="form-field">
                <input type="text" class="text" name="user_name" placeholder="Enter your name" required>
            </div>
            <div class="form-field">
                <input type="email" class="text" name="user_email" placeholder="Enter your email" required>
            </div>
            <div class="form-field">
