...
if ( ! function_exists( 'process' ) ) {
    function process($post) {
        ...
        // Validate email
        $filter_email = filter_var($post['user_email'], FILTER_VALIDATE_EMAIL);
        ...
        $stmt = $mysql->prepare("
            INSERT INTO users (user_name,user_email,frequency,interests,country,comment) 
            VALUES(?,?,?,?,?,?)
        ");
        
        $stmt->bind_param("ssssss", 
            $filter_post['user_name'], $filter_email, $filter_post['frequency'], 
