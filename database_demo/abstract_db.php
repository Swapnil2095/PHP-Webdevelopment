...
print_r($db->update('objects', array('post_title'=>'Abstraction Test Update', 'post_content' => 'Abstraction test update content'), array('%s', '%s'), array('ID'=>1), array('%d')));
print_r($db->get_results("SELECT * FROM objects"));
print_r($db->get_row("SELECT * FROM objects"));
print_r($db->delete('objects', 19));